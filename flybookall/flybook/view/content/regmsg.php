...
<table id="table">
	...
	<tr><td>院系专业：</td><td><input type="text" name="spro"></td></tr>
	<tr><td>公寓住址：</td><td><input type="text" name="addr"></td></tr>
	<tr><td>Tel：</td><td><input type="text" name="tel"></td></tr>
	<tr><td>email：</td><td><input type="text" name="email"></td></tr>
	<tr><td>QQ/MSN：</td><td><input type="text" name="im"></td></tr>
	<tr><td>特长爱好：</td><td><input type="text" name="especial"></td></tr>
	<tr><td>家乡：</td><td><input type="text" name="homeAddr"></td></tr>
	<tr><td>加入部门：</td><td><input type="text" name="part"></td></tr>
	<tr><td>生日：</td><td><input type="text" name="bri"></td></tr>
	<tr><td>自我简述：</td><td><input type="text" name="selfIntro"></td></tr>
